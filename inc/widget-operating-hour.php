...
class UKMTheme_Operating_Hour extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Office or counter oerating hour', 'ukmtheme' ), ) // Args
		);
	}
  ...
  <p style="margin-top: 0;">
    ...
    <?php _e( '08:00 - 16:30<br>(13:00-14:00 Close)', 'ukmtheme' ); ?><br>
    <strong><?php _e( 'Friday', 'ukmtheme' ); ?></strong><br>
    <?php _e( '08:00 - 16:30<br> (12:15-14:45 Close)', 'ukmtheme' ); ?><br>
